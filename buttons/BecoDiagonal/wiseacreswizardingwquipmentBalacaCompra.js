...
module.exports = {
    customID: 'wiseacreswizardingwquipmentBalacaCompra',
    async execute(interaction, client) {
        ...
        if(userInv.inventario.balanca_latao) {
            userInv.inventario.balanca_latao.amount += 1
        }else{
            userInv.inventario.balanca_latao.amount = {name: 'Balança de Latão', amount: 1};
        }
        ...
        return interaction.reply({ content: `Você comprou 1 Balança de Latão`, ephemeral: true });
    }
}