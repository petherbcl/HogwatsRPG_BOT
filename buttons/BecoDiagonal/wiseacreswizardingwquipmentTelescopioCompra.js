...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if(userInv.inventario.telescopio) {
            userInv.inventario.telescopio.amount += 1
        }else{
            userInv.inventario.telescopio.amount = {name: 'Telescópio', amount: 1};
        }
        ...
        return interaction.reply({ content: `Você comprou 1 Telescópio`, ephemeral: true });
    }
}