...
module.exports = {
    customID: 'boticarioslugjiggersCompra',
    async execute(interaction, client) {
        ...
        if(userInv.inventario.frasco_vazio) {
            userInv.inventario.frasco_vazio.amount += 1
        }else{
            userInv.inventario.frasco_vazio.amount = {name: 'Frasco Vazio', amount: 1};
        }
